    ...
    () async => const ChecklistEntity(
      ...
      items: [
        ...
        ChecklistItemEntity(
          id: 2,
          order: 2,
          question: 'Clean the basins',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 3,
          order: 3,
          question: 'Clean the commode and urinal',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 4,
          order: 4,
          question: 'Clean the rubbish bin',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 5,
          order: 5,
          question: 'Clean and dry the floor',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 6,
        ...
        ChecklistItemEntity(
          id: 7,
          order: 7,
          question: 'Tap or something is broken',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 8,
          order: 8,
          question: 'Tissue is available',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 9,
          order: 9,
          question: 'Soap/handwash is available',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 10,
          order: 10,
          question: 'Cleaning supplies are properly stored in the storeroom',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 11,
          order: 11,
          question: 'Toilet cleaning supplies',
          answerType: ChecklistAnswerType.star,
        ),
        ChecklistItemEntity(
          id: 12,
          order: 12,
          question: 'The caretaker is dressed appropriately',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 13,
          order: 13,
          question: 'The caretaker is dancing happily',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 14,
          order: 14,
          question: 'The patient is eating',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 15,
          order: 15,
          question: 'The caretaker is giving medicine',
          answerType: ChecklistAnswerType.yesNo,
        ),
        ChecklistItemEntity(
          id: 16,
          order: 16,
          question: 'Repair work',
          answerType: ChecklistAnswerType.repairWork,
        ),
      ],
      issues: [
