...
final class GetSupplyRequestDetailsUseCase {
  GetSupplyRequestDetailsUseCase(this._repository, this._authRepository);
  ...
  Future<Result<SupplyRequestEntity, Failure>> call(
    ...
    final result = await _repository.getSupplyRequestDetails(
      partnerId,
      supplyRequestId,
    );
