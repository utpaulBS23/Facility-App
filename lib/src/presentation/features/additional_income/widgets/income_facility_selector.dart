...
class _IncomeFacilitySelector extends StatelessWidget {
  const _IncomeFacilitySelector({required this.facilityName, this.onTap});
...
class _IncomeFacilityPickerSheet extends StatelessWidget {
  const _IncomeFacilityPickerSheet({
