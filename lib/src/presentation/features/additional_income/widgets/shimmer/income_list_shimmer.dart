...
/// Shimmer skeleton matching [_IncomeListCard].
class _IncomeCardShimmer extends StatelessWidget {
  const _IncomeCardShimmer();
...
/// List of shimmer skeletons matching [_IncomeListCard].
class _IncomeListShimmer extends StatelessWidget {
  const _IncomeListShimmer();
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, _) => const _IncomeCardShimmer(),
    );
  }
}
